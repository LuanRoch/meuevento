...
const Event = ({ event }) => {
  return (
    <div className="bg-white/5 hover:bg-white/10 transition-all h-[440px] rounded-3xl flex flex-col justify-start
    p-4 w-[320px] sm:full mx-auto sm:mx-0">
      <div className="relative w-full h-[320px] mb-10">
        ...
        />
        <div className="absolute -bottom-[24px] left-4 bg-accent w-[110px] h-[48px] text-[13px] uppercase
